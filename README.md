...
让**任何机型**（包括 Pixel、nothing等非白名单设备）完整使用微信实况照片（Live Photo）功能：相册 LIVE 识别、聊天/朋友圈发送、接收查看、保存导出——**无需等待官方热补丁**。
...
测试环境：Redmi K30 Pro（Android 16 / Play 8.0.72 小号观察中）、Google Pixel 9 Pro XL（Android 17 / 8.0.78 build 3180 无补丁 主号，已验证发表直通），另回归 8.0.77 有补丁环境。
...
- 微信版本升级后混淆类名会变化 → 模块按**方法签名结构**在 APK 内自动探测关键类（remux worker / 包装类 / 结果类），不依赖固定类名；已实测 8.0.77 单包 3160 / split 包 3141、Play 8.0.72、8.0.78 3160 / e12 / 3180
